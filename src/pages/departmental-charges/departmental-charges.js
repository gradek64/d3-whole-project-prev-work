...
angular
  .module('pages.departmental-charges', [
    'ngRoute',
    'utils.events',
    'utils.constants',
  ...
  .config([
    ...
    function($routeProvider, USER_ROLES) {
      $routeProvider
        .when('/departmental-charges/variance/:component?', {
          templateUrl: 'pages/departmental-charges/departmental-charges.html',
          controller: 'departmentalChargesCtrl',
          data: {
        ...
        .when('/departmental-charges/:component?', {
          templateUrl: 'pages/departmental-charges/departmental-charges.html',
          controller: 'departmentalChargesCtrl',
          data: {
            authorisedRoles: [USER_ROLES.ALL],
  ...
  .controller('departmentalChargesCtrl', [
    ...
    function(
      ...
      const mapFilters = (state) => {
        if (state) {
          return [
            {name: 'SOURCE_LEGAL_ENTITY', value: state.first.value},
            {name: 'TARGET_LEGAL_ENTITY', value: state.second.value},
            {name: 'TARGET_COST_CENTRE', value: state.third.value},
