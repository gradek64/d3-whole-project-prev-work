...
(function (ng, undefined){
  ...
  ng.module('smart-table', ['utils.events']).run(['$templateCache', function ($templateCache) {
  ...
  ng.module('smart-table')
  .directive('stPagination', ['stConfig', 'events', function (stConfig, events) {
    return {
      restrict: 'EA',
      require: '^stTable',
      scope: {
      ...
      link: function (scope, element, attrs, ctrl) {
        ...
        function redraw () {
          ...
          events.emit('ST-PAGINATION-CHANGED');
        }
